...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (match) {
    ...
    document.getElementById("recipeDetail").innerHTML =
      '<div class="error-detail">Invalid recipe ID</div>';
  }
});
  ...
  try {
    ...
    if (reviewBtn) {
      reviewBtn.addEventListener("click", () => {
        window.location.href = `/recipe/${id}/reviews`;
      });
    }
    ...
    if (ratingBtn) {
      ratingBtn.addEventListener("click", () => {
        window.location.href = `/recipe/${id}/ratings`;
      });
    }
  } catch (error) {
...
function displayRecipeDetail(container, recipe) {
  container.innerHTML = `
        ...
        <div class="recipe-action-buttons">
          ...
          <button id="reviewBtn" class="btn-review">
              💬 Reviews
          </button>
          <button id="ratingBtn" class="btn-rating">
              ⭐ Ratings
          </button>
        </div>
    `;
