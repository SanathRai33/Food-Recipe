...
const ActivityFeed = () => {
    ...
    const loadActivities = async (reset = true) => {
        ...
        try {
            ...
            const response = await activityAPI.getActivityFeed(params);
    ...
    const formatActivityText = (activity) => {
        ...
        switch (activity.type) {
            case 'created_recipe':
                return (
                    <>
                        <strong>{username}</strong> created recipe{' '}
            ...
            case 'favorited_recipe':
                return (
                    <>
                        <strong>{username}</strong> favorited{' '}
                        <Link to={`/recipe/${data.recipe_id}`} className="text-primary-600 hover:underline">
                            "{data.recipe_title}"
                        </Link>
                    </>
    ...
    return (
        <div className="max-w-3xl mx-auto">
            <div className="mb-6">
                ...
                <p className="text-gray-600">Activities from people you follow</p>
            </div>
